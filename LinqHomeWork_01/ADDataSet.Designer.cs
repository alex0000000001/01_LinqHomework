...
namespace LinqHomeWork_01.ADDataSetTableAdapters {
...
SELECT ProductPhotoID, ThumbNailPhoto, ThumbnailPhotoFileName, LargePhoto, LargePhotoFileName, ModifiedDate FROM Production.ProductPhoto WHERE (ProductPhotoID = @ProductPhotoID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LinqHomeWork_01.Properties.Settings.Default.AdventureWorksConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT DISTINCT DATEPART(yyyy, ModifiedDate) AS \'yyy\'\r\nFROM      Production.Produ" +
                "ctPhoto\r\nORDER BY \'yyy\'";
        ...
        public virtual int Fill(ADDataSet.ProductPhotoDataTable dataTable) {
        ...
        public virtual ADDataSet.ProductPhotoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ADDataSet.ProductPhotoDataTable dataTable = new ADDataSet.ProductPhotoDataTable();
        ...
        public virtual int FillByyear(ADDataSet.ProductPhotoDataTable dataTable) {
        ...
        public virtual ADDataSet.ProductPhotoDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            ADDataSet.ProductPhotoDataTable dataTable = new ADDataSet.ProductPhotoDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ADDataSet.ProductPhotoDataTable dataTable) {
